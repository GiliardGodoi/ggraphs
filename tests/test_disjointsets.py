...
from ggraphs.util import has_cycle, gg_total_weight, gg_edges_number
from ggraphs.mst import kruskal
from disjointset.main import DisjointSet, Subset
...
class TestDisjointSets(unittest.TestCase):
    ...
    def test_attributes(self):
        ...
        self.assertTrue(hasattr(DS, "get_sets"))
    ...
    def test_inserting_item(self):
        ...
        self.assertEqual(len(DS), len(DS.get_sets()))
